...
export default function FoodPage() {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      {/* INPUT CARD */}
      <section className="bg-white/5 border border-white/10 rounded-xl p-5 backdrop-blur-md shadow-sm">
        <form onSubmit={handleAnalyze} className="space-y-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 focus:border-emerald-500/50 rounded-lg px-4 py-3 text-xs text-white outline-none transition-all placeholder:text-gray-600"
              required
              disabled={loading}
            />
          </div>
      ...
      {/* RESULTS CARD */}
      {result && (
        <section className="bg-white/5 border border-white/10 rounded-xl p-5 backdrop-blur-md shadow-md animate-slideUp space-y-5">
